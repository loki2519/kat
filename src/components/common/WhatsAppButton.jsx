...
export default function WhatsAppButton() {
  return (
    <a
      ...
      aria-label="Chat with KAT on WhatsApp"
      className="fixed bottom-6 right-6 z-40 group flex items-center gap-2 bg-[#25D366] text-white p-3.5 sm:px-4 sm:py-3 rounded-full shadow-lg hover:shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 cursor-pointer focus:outline-none"
    >
